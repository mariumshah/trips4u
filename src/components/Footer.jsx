    ...
    <div className="mt-40 flex flex-col gap-5 px-8">
      <div className="flex justify-between items-start flex-col md:flex-row gap-7">
        <div className="flex justify-start items-start">
          <h1 className="text-[#605DEC] font-bold text-2xl">Trips4u</h1>
        </div>
        <ul className="flex flex-col items-start justify-start gap-3">
          <h2 className="text-[#6E7491] font-bold text-lg">About</h2>
          <li className="footerLi">About Trips4u</li>
        ...
        <ul className="flex flex-col items-start justify-start  gap-3">
          ...
          <li className="footerLi">Trips4u for Android</li>
          <li className="footerLi">Trips4u for iOS</li>
      ...
      <div className="border-t-2 border-[#CBD4E6] py-8 flex justify-between items-center">
        ...
        <p className="text-[#7C8DB0] text-sm sm:text-base">&copy; 2025 Trips4u incorporated</p>
      </div>
    </div>
    </>
  )
